...
public class TelaIdioma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblIdioma.setBackground(new java.awt.Color(51, 255, 0));
        lblIdioma.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblIdioma.setForeground(new java.awt.Color(255, 51, 0));
        lblIdioma.setText("Click no Botão");

        btnIdioma.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnIdioma.setText("Click Aqui");
    ...
    private void btnIdiomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIdiomaActionPerformed
      ...
      lblIdioma.setText(lingua.getDisplayLanguage());
